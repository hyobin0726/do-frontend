        ...
        <main className="w-full flex flex-col items-center space-y-5 py-10 px-5">
            <div className="w-full">
                <Link href={`/crewsetting/${crewId}/info`} passHref>
                    <div className="w-full flex flex-row justify-between items-center shadow-md rounded-lg p-6 text-center border-2 border-hobbing-pink text-hobbing-pink font-medium">
                        <p>소모임 정보</p>
