        ...
        <section>
            {chat.text && (
                <div className="flex flex-row">
                    ...
                    <div className="bg-hobbing-red text-white py-2 px-4 rounded-lg text-end w-fit justify-end">
                        {chat.text}
                    </div>
                </div>
            )}
            {chat.imageUrl && (
                <div className="flex flex-row">
                    ...
                    <div className="bg-hobbing-red text-white py-2 px-4 rounded-lg w-fit justify-end">
